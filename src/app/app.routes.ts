...
import { DownloadEmployeeComponent } from './components/download_employee/download_employee.component';
...
export const routes: Routes = [
  ...
  { path: 'download-employee', component: DownloadEmployeeComponent }
];
